...
\hypertarget{class_b_tree_index_ae737b5dea98c2e2036fd3b3d9bdcfc22}{}\index{B\+Tree\+Index@{B\+Tree\+Index}!B\+Tree\+Index@{B\+Tree\+Index}}
\index{B\+Tree\+Index@{B\+Tree\+Index}!B\+Tree\+Index@{B\+Tree\+Index}}
\subsubsection[{B\+Tree\+Index}]{\setlength{\rightskip}{0pt plus 5cm}B\+Tree\+Index\+::\+B\+Tree\+Index (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)}\label{class_b_tree_index_ae737b5dea98c2e2036fd3b3d9bdcfc22}


Constructor of \hyperlink{class_b_tree_index}{B\+Tree\+Index} that sets up the initial variables It needs to compute number of total keys per level, given max keys per page. 

Constructor of \hyperlink{class_b_tree_index}{B\+Tree\+Index} that sets up the initial variables 
...
\hline
\end{DoxyParams}
\hypertarget{class_b_tree_index_a768090c78f62663632baa93b3786552f}{}\index{B\+Tree\+Index@{B\+Tree\+Index}!probe@{probe}}
...
\begin{DoxyParamCaption}
\item[{uint64\+\_\+t}]{key, }
\item[{F\+I\+L\+E $\ast$}]{index\+File}
\end{DoxyParamCaption}
)}\label{class_b_tree_index_a768090c78f62663632baa93b3786552f}


This method is not being used in the current implementation of probe. btree quality probe on a single key using file handler. First, it traverses the btree index, then it calls probe\+\_\+bin to probe the binary data file, looking for the offset of the key. 


\begin{DoxyParams}{Parameters}
{\em key} & the key we are probing for \\
\hline
{\em index\+File} & file handler of the btree index file \\
\hline
\end{DoxyParams}
